...
<style scoped>
button {
  background-color: #000000; /* สีพื้นหลังปุ่ม */
  border: none; /* ไม่แสดงขอบ */
  color: rgb(107, 106, 106); /* สีตัวอักษร */
...
button:hover {
  background-color: #ffffff; /* สีพื้นหลังเมื่อ hover */
}

button:active {
  background-color: #3a3b3b; /* สีพื้นหลังเมื่อกดปุ่ม */
}
.background {
...
h1 {
  text-align: center;
  margin-top: 20px;
  color: #090909; /* สีของข้อความ */
}

.user-info-container {
  background-color: rgba(111, 104, 104, 0.8); /* พื้นหลังขาวโปร่งใส */
  padding: 20px;
  border-radius: 10px;
