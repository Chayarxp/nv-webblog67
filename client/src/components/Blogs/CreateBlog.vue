<template>
  <div>
    <h1><center>Add Planet</center></h1>
    <form v-on:submit.prevent="createBlog" enctype="multipart/form-data" novalidate>
      <p>Planet Name: <input type="text" v-model="blog.Planet" /></p>
      <p>Size: <input type="text" v-model="blog.Size" /></p>
      <p>Mass: <input type="text" v-model="blog.Mass" /></p>
      <p>Surface Gravity: <input type="text" v-model="blog.Gravity" /></p>
      <p>Rotation Period: <input type="text" v-model="blog.Period" /></p>
...
export default {
  data() {
    return {
      ...
      pictureIndex: 0,
      blog: {
  Planet: "",   // ชื่อดาวเคราะห์
  Size: "",     // ขนาด
  Mass: "",     // มวล
  Gravity: "",  // แรงโน้มถ่วงผิว
  Period: "",   // คาบการหมุน
  thumbnail: "null",  // รูปภาพ Thumbnail
  pictures: "null",   // รูปภาพ
